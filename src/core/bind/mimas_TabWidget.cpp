 ...
 * bind/QWidget.h:55
 */
static int TabWidget_setCssClass(lua_State *L) {
  try {
    TabWidget *self = *((TabWidget **)dub_checksdata(L, 1, "mimas.TabWidget"));
 ...
 * bind/QWidget.h:56
 */
static int TabWidget_setSizeHit(lua_State *L) {
  try {
    TabWidget *self = *((TabWidget **)dub_checksdata(L, 1, "mimas.TabWidget"));
    int w = dub_checkint(L, 2);
    int h = dub_checkint(L, 3);
...
static const struct luaL_Reg TabWidget_member_methods[] = {
  ...
  { "setCssClass"  , TabWidget_setCssClass },
  { "setSizeHit"   , TabWidget_setSizeHit },
