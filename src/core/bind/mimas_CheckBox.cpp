 ...
 * bind/QWidget.h:55
 */
static int CheckBox_setCssClass(lua_State *L) {
  try {
    CheckBox *self = *((CheckBox **)dub_checksdata(L, 1, "mimas.CheckBox"));
 ...
 * bind/QWidget.h:56
 */
static int CheckBox_setSizeHit(lua_State *L) {
  try {
    CheckBox *self = *((CheckBox **)dub_checksdata(L, 1, "mimas.CheckBox"));
    int w = dub_checkint(L, 2);
    int h = dub_checkint(L, 3);
...
static const struct luaL_Reg CheckBox_member_methods[] = {
  ...
  { "setCssClass"  , CheckBox_setCssClass },
  { "setSizeHit"   , CheckBox_setSizeHit  },
