 ...
 * bind/QWidget.h:17
 */
static int Widget_parentWidget(lua_State *L) {
  try {
    Widget *self = *((Widget **)dub_checksdata(L, 1, "mimas.Widget"));
 ...
 * bind/QWidget.h:39
 */
static int Widget_setToolTip(lua_State *L) {
  try {
    Widget *self = *((Widget **)dub_checksdata(L, 1, "mimas.Widget"));
    size_t text_sz_;
    const char *text = dub_checklstring(L, 2, &text_sz_);
 ...
 * bind/QObject.h:12
 */
static int Widget_parent(lua_State *L) {
  try {
    Widget *self = *((Widget **)dub_checksdata(L, 1, "mimas.Widget"));
...
static const struct luaL_Reg Widget_member_methods[] = {
  ...
  { "parentWidget" , Widget_parentWidget  },
...
extern "C" int luaopen_mimas_Widget(lua_State *L)
{
  ...
  dub_register(L, "mimas", "Widget_core", "Widget");
  // <mt>
  lua_pop(L, 1);
  return 0;
}
