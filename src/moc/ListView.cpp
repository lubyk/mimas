...
**
** Created: Sun Mar 18 14:44:44 2012
...
int ListView::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: sliderVActionTriggered((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: sliderHActionTriggered((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 2;
    }
