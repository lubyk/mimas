...
void SocketNotifier::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        SocketNotifier *_t = static_cast<SocketNotifier *>(_o);
        switch (_id) {
        case 0: _t->activatedSlot((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData SocketNotifier::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SocketNotifier::staticMetaObject = {
    { &QSocketNotifier::staticMetaObject, qt_meta_stringdata_SocketNotifier,
      qt_meta_data_SocketNotifier, &staticMetaObjectExtraData }
};
