...
void FileObserver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        FileObserver *_t = static_cast<FileObserver *>(_o);
        switch (_id) {
        case 0: _t->pathChangedSlot((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData FileObserver::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject FileObserver::staticMetaObject = {
    { &QFileSystemWatcher::staticMetaObject, qt_meta_stringdata_FileObserver,
      qt_meta_data_FileObserver, &staticMetaObjectExtraData }
};
